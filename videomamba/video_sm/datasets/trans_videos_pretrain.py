...
def process_single(video_info, dataset, index_count, mapping_dict):
    ...
    if "Negative" in video_path:
        video_path = video_path.replace("SUN-Negative", "indexed")
...
for dataset in datasets.keys():
    ...
    videolist = read_txt(os.path.join("/mnt/tqy/SUN-SEG/SUN-SEG-Annotation/TrainDataset", 'sun_seg.txt'))
