...
class VisionMamba(nn.Module):
    ...
    def forward_features(self, x, inference_params=None):
        ...
        # frame_features = hidden_states[:, 1:]
        frame_features = hidden_states.view(B, T, -1, C) 
        frame_features = frame_features.mean(dim=2) 
        
        # frame_features = frame_features.view(B, -1, T, C) 
        # frame_features = frame_features.mean(dim=1) 
        
        return frame_features, inference_params
