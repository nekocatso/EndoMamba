...
def get_args():
    ...
    parser.add_argument(
        "--output_dir",
        default="/home/tqy/out/AutoLaparo",
...
def main(args, ds_init):
    ...
    if args.only_cls_token:
        args.output_dir = os.path.join(args.output_dir, "ct")
    
    if args.log_dir is not None:
        args.log_dir = os.path.join(args.output_dir, "log")
    elif args.log_dir == "None":
        args.log_dir = None
    ...
    if global_rank == 0 and args.log_dir is not None and not args.eval:
        ...
        log_writer = utils.WandbLogger(project_name="SurgicalPhase", log_dir=args.log_dir)
        # log_writer = None
    ...
    if "endomamba" or "videomamba" in args.model:
    ...
    if "endomamba" or "videomamba" in args.model:
        ...
        optimizer = torch.optim.SGD(
            [{'params': model.parameters(), 'lr': args.lr, 'weight_decay': 0, 'lr_scale': 1}],
            momentum=0.9,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            if log_writer is not None:
                log_writer.update(val_acc1=test_stats["acc1"], head="val")
                log_writer.update(val_acc5=test_stats["acc5"], head="val")
                log_writer.update(val_loss=test_stats["loss"], head="val")
