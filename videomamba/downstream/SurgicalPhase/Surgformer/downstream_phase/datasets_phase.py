...
from datasets.phase.AutoLaparo_phase_sequence import PhaseDataset_AutoLaparo_Sequence
...
def build_smart_test_dataset(is_train, test_mode, fps, args, current_video_id):
    """Load video phase recognition dataset."""
    mode = None
    anno_path = None
    mode = "test"
